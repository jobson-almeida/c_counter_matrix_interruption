...
/* 
* frames/itens estão no formato hexadecimal, que representam cada um dos números de 0 a 9, uma representação específica para a matriz 5x5 da placa de desenvolvimento BitLogLab
