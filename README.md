...
Esse programa se refere a uma proposta de atividade do curso de capacitação para a residência EmbarcaTech, cujos alguns dos propósitos está em avalizr o conhecimento e as possibilidade de aplicação dos recursos de interruoção disponibilizados no PICO SDK, na placa de desenvolvimento Pico W e por consequência no microcontrolador RP20240, utilizando-se para tal a placa educacional de desenvolvimento chamada BitDogLab.<br><br><br>

## O programa
Conforme solicitado, foi desenvolvido uma estrutura em código capaz de exibir em uma matriz de LEDs RGB, com layout 5 x 5, uma representação numérica de 0 à 9 onde dois botões foram utilizados como os dispositivos de entrada responsáveis pelo incremento e decremento ordenado dos números a serem exibidos. 
Em seu início o programa executa a primeira exibição de um número, partindo do número '0' e estático aguardando pela ação do usuário sobre clicar no botão
<br><br><br>
